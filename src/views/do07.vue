...
export default {
  ...
  methods: {
    async generatePDF(datas) {
      ...
      page.drawText(`เลขประจำตัวผู้เสียภาษี 0115536007768                                                                                              เลขที่           124/66`, { x: 50, y: 700, size: 14, font: thaiFont });
      ...
      page.drawText(`SC SONGKHLA TO DEALER - FLEXIBLE`, { x: 100, y: 370, size: 14, font: thaiFont, color: rgb(0, 0, 1) });
      ...
      page.drawText(`548`, { x: 320, y: 430, size: 14, font: thaiFont, color: rgb(0, 0, 1) });
      ...
      page.drawText(`217,101`, { x: 480, y: 430, size: 14, font: thaiFont, color: rgb(0, 0, 1) });
      ...
      page.drawText(`217,101`, {  x: 470, y: 310, size: 14, font: thaiFont, color: rgb(0, 0, 1) });
      ...
      page.drawText(`รวม สองแสนหนึ่งหมื่นเจ็ดพันหนึ่งร้อยเอ็ดบาทถ้วน`, {  x: 50, y: 290, size: 14, font: thaiFont });
