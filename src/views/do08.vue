...
export default {
  ...
  methods: {
    async generatePDF(datas) {
      ...
      page.drawText(`เลขประจำตัวผู้เสียภาษี 0115536007768                                                                                              เลขที่           126/66`, { x: 50, y: 700, size: 14, font: thaiFont });
      ...
      page.drawText(`เปลี่ยนสถานที่ส่งรถใหม`, { x: 100, y: 370, size: 14, font: thaiFont, color: rgb(0, 0, 1) });
      ...
      page.drawText(`2,498`, { x: 320, y: 430, size: 14, font: thaiFont, color: rgb(0, 0, 1) });
      ...
      page.drawText(`494,883`, { x: 480, y: 430, size: 14, font: thaiFont, color: rgb(0, 0, 1) });
      ...
      page.drawText(`494,883`, {  x: 470, y: 310, size: 14, font: thaiFont, color: rgb(0, 0, 1) });
      ...
      page.drawText(`รวม สี่แสนเก้าหมื่นสี่พันแปดร้อยแปดสิบสามบาทถ้วน`, {  x: 50, y: 290, size: 14, font: thaiFont });
