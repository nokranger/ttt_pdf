...
export default {
  ...
  methods: {
    async generatePDF(datas) {
      ...
      page.drawText(`เลขประจำตัวผู้เสียภาษี 0115536007768                                                                                              เลขที่           121/66`, { x: 50, y: 700, size: 14, font: thaiFont });
      ...
      page.drawText(`YARD TO DEALER - DOMESTIC METRO`, { x: 100, y: 370, size: 14, font: thaiFont, color: rgb(0, 0, 1) });
      ...
      page.drawText(`14,101`, { x: 320, y: 430, size: 14, font: thaiFont, color: rgb(0, 0, 1) });
      ...
      page.drawText(`3,651,915`, { x: 480, y: 430, size: 14, font: thaiFont, color: rgb(0, 0, 1) });
      ...
      page.drawText(`3,651,915`, {  x: 470, y: 310, size: 14, font: thaiFont, color: rgb(0, 0, 1) });
      ...
      page.drawText(`รวม สามล้านหกแสนห้าหมื่นหนึ่งพันเก้าร้อยสิบห้าบาทถ้วน`, {  x: 50, y: 290, size: 14, font: thaiFont });
