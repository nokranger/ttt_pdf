...
export default {
  ...
  methods: {
    async generatePDF(datas) {
      ...
      page.drawText(`เลขประจำตัวผู้เสียภาษี 0115536007768                                                                                              เลขที่           123/66`, { x: 50, y: 700, size: 14, font: thaiFont });
      ...
      page.drawText(`YARD TO DEALER - DOMESTIC UPCOUNTRY`, { x: 100, y: 370, size: 14, font: thaiFont, color: rgb(0, 0, 1) });
      ...
      page.drawText(`32,489`, { x: 320, y: 430, size: 14, font: thaiFont, color: rgb(0, 0, 1) });
      ...
      page.drawText(`18,341,550.63`, { x: 480, y: 430, size: 14, font: thaiFont, color: rgb(0, 0, 1) });
      ...
      page.drawText(`18,341,550.63`, {  x: 470, y: 310, size: 14, font: thaiFont, color: rgb(0, 0, 1) });
      ...
      page.drawText(`รวม สิบแปดล้านสามแสนสี่หมื่นหนึ่งพันห้าร้อยห้าสิบบาทหกสิบสามสตางค์`, {  x: 50, y: 290, size: 14, font: thaiFont });
