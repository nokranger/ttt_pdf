...
export default {
  ...
  methods: {
    async generatePDF(datas) {
      ...
      page.drawText(`เลขประจำตัวผู้เสียภาษี 0115536007768                                                                                              เลขที่           122/66`, { x: 50, y: 700, size: 14, font: thaiFont });
      ...
      page.drawText(`SP&SW&TAC TO DEALER - DOMESTIC METRO`, { x: 100, y: 370, size: 14, font: thaiFont, color: rgb(0, 0, 1) });
      ...
      page.drawText(`70`, { x: 320, y: 430, size: 14, font: thaiFont, color: rgb(0, 0, 1) });
      ...
      page.drawText(`29,400`, { x: 480, y: 430, size: 14, font: thaiFont, color: rgb(0, 0, 1) });
      ...
      page.drawText(`29,400`, {  x: 470, y: 310, size: 14, font: thaiFont, color: rgb(0, 0, 1) });
      ...
      page.drawText(`รวม สองหมื่นเก้าพันสี่ร้อยบาทถ้วน`, {  x: 50, y: 290, size: 14, font: thaiFont });
