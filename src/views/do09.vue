...
export default {
  ...
  methods: {
    async generatePDF(datas) {
      ...
      page.drawText(`เลขประจำตัวผู้เสียภาษี 0115536007768                                                                                              เลขที่           129/66`, { x: 50, y: 700, size: 14, font: thaiFont });
      ...
      page.drawText(`(Domestics match trip with Shuttle )`, { x: 100, y: 370, size: 14, font: thaiFont, color: rgb(0, 0, 1) });
      ...
      page.drawText(`13`, { x: 320, y: 430, size: 14, font: thaiFont, color: rgb(0, 0, 1) });
      ...
      page.drawText(`46,566.67`, { x: 480, y: 430, size: 14, font: thaiFont, color: rgb(0, 0, 1) });
      ...
      page.drawText(`215,286.34`, {  x: 470, y: 310, size: 14, font: thaiFont, color: rgb(0, 0, 1) });
      ...
      page.drawText(`รวม สองแสนหนึ่งหมื่นห้าพันสองร้อยแปดสิบหกบาทสามสิบสี่สตางค์`, {  x: 50, y: 290, size: 14, font: thaiFont });
