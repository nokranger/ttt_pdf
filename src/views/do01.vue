...
export default {
  ...
  methods: {
    async generatePDF(datas) {
      ...
      page.drawText(`SC SONGKHLA TO DEALER`, { x: 100, y: 370, size: 14, font: thaiFont, color: rgb(0, 0, 1) });
      ...
      page.drawText(`16`, { x: 320, y: 430, size: 14, font: thaiFont, color: rgb(0, 0, 1) });
      ...
      page.drawText(`6,112.25`, { x: 480, y: 430, size: 14, font: thaiFont, color: rgb(0, 0, 1) });
      ...
      page.drawText(`6,112.25`, {  x: 470, y: 310, size: 14, font: thaiFont, color: rgb(0, 0, 1) });
      ...
      page.drawText(`รวม หกพันหนึ่งร้อยสิบสองบาทยี่สิบบาทห้าสตางค์`, {  x: 50, y: 290, size: 14, font: thaiFont });
