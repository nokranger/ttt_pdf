...
export default {
  ...
  methods: {
    async generatePDF(datas) {
      ...
      page.drawText(`เลขประจำตัวผู้เสียภาษี 0115536007768                                                                                              เลขที่           120/66`, { x: 50, y: 700, size: 14, font: thaiFont });
      ...
      page.drawText(`METRO TRANSPORTATION / FLATBED`, { x: 100, y: 370, size: 14, font: thaiFont, color: rgb(0, 0, 1) });
      page.drawText(`YARD TO DEALER`, { x: 100, y: 350, size: 14, font: thaiFont, color: rgb(0, 0, 1) });
      ...
      page.drawText(`43`, { x: 320, y: 430, size: 14, font: thaiFont, color: rgb(0, 0, 1) });
      ...
      page.drawText(`49,729`, { x: 480, y: 430, size: 14, font: thaiFont, color: rgb(0, 0, 1) });
      ...
      page.drawText(`49,729`, {  x: 470, y: 310, size: 14, font: thaiFont, color: rgb(0, 0, 1) });
      ...
      page.drawText(`รวม สี่หมื่นเก้าพันเจ็ดร้อยยี่สิบเก้าบาทถ้วน`, {  x: 50, y: 290, size: 14, font: thaiFont });
